...
exports.calculateOptimalPath = calculateOptimalPath;
function calculateOptimalPath(championName, gameTime, jungleState) {
...
function getCampGoldValue(campName) {
    const goldValues = {
        'Blue Buff': 110,
        'Red Buff': 110,
        'Gromp': 85,
...
function getCampXPValue(campName) {
    const xpValues = {
        'Blue Buff': 135,
        'Red Buff': 135,
        'Gromp': 105,
